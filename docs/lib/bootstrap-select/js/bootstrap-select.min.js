        ...
        if (e.is('select')) {
          ...
          if (t) {
            ...
            ;((r.template = P.extend(
              {},
              Y.DEFAULTS.template,
              P.fn.selectpicker.defaults ? P.fn.selectpicker.defaults.template : {},
              n.template,
              i.template,
            )),
    ...
    ;((Y.VERSION = '1.13.18'),
      ...
      (Y.prototype = {
          ...
          if (e || (!1 !== this.options.size && !Object.keys(this.sizeInfo).length)) {
            ...
            if (
              ...
              this.selectpicker.view.widestOption &&
                o.appendChild(this.selectpicker.view.widestOption.cloneNode(!0)),
              o.appendChild(t),
              o.appendChild(r),
              o.appendChild(l),
              d && s.appendChild(d),
        ...
        selectPosition: function () {
          ...
          function e(e) {
            var t = {},
              i =
                r.options.display ||
                (!!P.fn.dropdown.Constructor.Default && P.fn.dropdown.Constructor.Default.display)
            ;(r.$bsContainer
          ...
          if (
            ...
            for (var i = 0; i < t.selectpicker.view.visibleElements.length; i++) {
              var s = t.selectpicker.current.data[i + t.selectpicker.view.position0],
                n = s.option
              n &&
                (!0 !== e && t.setDisabled(s.index, s.disabled), t.setSelected(s.index, n.selected))
            }
        },
                ...
                ;(!C.multiple || (C.multiple && 1 === C.options.maxOptions)
                  ...
                  d &&
                    ((!C.multiple && a === s.selectedIndex) ||
                      ((T = [h.index, p.prop('selected'), l]), C.$element.triggerNative('change'))))
              }
            }),
            this.$menu.on(
              'click',
            ...
            this.$button
              ...
              .on('blur' + j, function (e) {
                void 0 !== C.selectpicker.view.tabindex &&
                  e.originalEvent &&
                  e.originalEvent.isTrusted &&
                  (C.$element[0].setAttribute('tabindex', C.selectpicker.view.tabindex),
        ...
        liveSearchListener: function () {
          ...
          ;(this.$button.on('click.bs.dropdown.data-api', function () {
            u.$searchbox.val() &&
              (u.$searchbox.val(''), (u.selectpicker.search.previousValue = void 0))
          }),
            this.$searchbox.on(
            ...
            this.$searchbox.on('input propertychange', function () {
              ...
              if (((u.selectpicker.search.elements = []), (u.selectpicker.search.data = []), e)) {
                ...
                ;((u.activeIndex = void 0),
                  ...
                  function (e, t) {
                    e.length ||
                      ((_.noResults.innerHTML = this.options.noneResultsText.replace(
                        '{0}',
                        '"' + S(t) + '"',
                      )),
                ...
                u.selectpicker.search.previousValue && (u.$menuInner.scrollTop(0), u.createView(!1))
